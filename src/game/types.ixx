...
export constexpr int LAYOUT_MINIMAP_X = LAYOUT_DEBUG_X + DEBUG_PANEL_W + 40;
export constexpr int LAYOUT_MINIMAP_Y = 10;
export constexpr int LAYOUT_MINIMAP_W = MAP_COLS * 14 + 20;
export constexpr int LAYOUT_MINIMAP_H = WINDOW_H;
export constexpr int LAYOUT_CONSOLE_X = LAYOUT_GAME_X;
export constexpr int LAYOUT_CONSOLE_Y = LAYOUT_GAME_Y + WINDOW_H + 60;
export constexpr int LAYOUT_CONSOLE_W = LAYOUT_MINIMAP_X + LAYOUT_MINIMAP_W - LAYOUT_CONSOLE_X;
